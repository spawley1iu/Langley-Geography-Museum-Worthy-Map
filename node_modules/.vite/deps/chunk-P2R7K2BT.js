  ...
  renderFrame_(time) {
    ...
    if (frameState) {
      ...
      if (previousFrameState) {
        const moveStart = !this.previousExtent_ || !isEmpty2(this.previousExtent_) && !equals(frameState.extent, this.previousExtent_);
        if (moveStart) {
          this.dispatchEvent(
...
export {
  createDefaultStyle2 as createDefaultStyle,
  BaseVector_default,
...
//# sourceMappingURL=chunk-P2R7K2BT.js.map
